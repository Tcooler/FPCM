...
result = Train(train_data,test_data,model_save_dir=model_file,device=device,pre_trained_model_dir=pre_trained_model_dir,lr=lr,mask_flag=True,alpha=alpha,min_layernumber=min_layernumber,loss_k=k)
